...
def seed_restaurant():
    with app.app_context():
        ...
        if existing:
            print("⚠️  El restaurante de prueba ya existe. Saltando...")
            print(f"   Catálogo: http://localhost:5173/restaurante-sabores")
            return
        ...
        print("✅ Restaurante de prueba creado exitosamente!\n")
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
